...
let laserSound = new Sound("./audio/pew.m4a", 5, 0.4);
let thrustSound = new Sound("./audio/thrust.m4a");
let hitSound = new Sound("./audio/hit.m4a", 5, 0.8);
let explosionSound = new Sound("./audio/explosion.mp4", 1, 0.7);

// MUSIC
let music = new Music("./audio/music-high.m4a", "./audio/music-low.m4a");
