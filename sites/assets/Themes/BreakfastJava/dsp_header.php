...
<TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="750" HEIGHT="50" ALIGN="center">
	...
	<TR>
		<TD BGCOLOR="PapayaWhip" ALIGN="center"><IMG SRC="/assets/images/pixel.gif" HEIGHT="18" BORDER="0"></TD>
	</TR>
	<TR>
		<TD>
		...
		<TABLE CELLPADDING="10" CELLSPACING="0" BORDER="0" BGCOLOR="white" WIDTH="100%">
			<TR VALIGN="top">
				...
				<?include ('/www/chizeledlight/assets/Themes/BreakfastJava/dsp_MenuLeft.php')?>
