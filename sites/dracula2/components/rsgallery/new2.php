...
if (isset($submit))
	...
	<table border="0" width="300">
		...
		<tr>
			<td><?echo _GALLERY_FORMCREATE_NAME;?>:</td>
			<td><input class="inputbox" type="text" name="catname" value=""></td>
		</tr>
		<tr>
			<td colspan="2" align="center">&nbsp;&nbsp;
			<input class="button" type="submit" value="<?echo _GALLERY_BUTTON_CREATE;?>"></td>
			<input type='hidden' name='submit' value='anythingatall'>
		</tr>
	</table>
	</FORM>
	</CENTER>
