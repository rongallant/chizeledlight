...
if (sizeof($regUsrForums)>0 and in_array($forum,$regUsrForums) and $mini_user_id==0) {
...
$TT = $topicTitle;
$topicTitle=textFilter($topicTitle,$topic_max_length,$post_word_maxlength,0,1,0,$mini_user_id);
}
...
$topic=DB_query(22,0); 
if($topic>0) require('components/minibb/bb_func_pthread.php');
else {
