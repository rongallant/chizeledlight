...
$l_search[10] = 'Search phrase length can`t be more than 100 symbols. Also minimum length of any word is 3 in "Any words" type of search and at least one word must be more than 2 symbols in any other type of search.';
...
$l_removeUser = 'Remove user from Forum';
$l_enterID = 'Enter ID';
...
$l_incorrectIp = 'Incorrect IP! Use 4 numbers separated by dot (Ex.: 195.12.145.16) or with plus at the end (Ex.: 195.12.145.+)';
